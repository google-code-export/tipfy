...
templates_dir = os.path.join(current_dir, 'resources', 'jinja2_templates')
templates_compiled_target = os.path.join(current_dir, 'resources', 'jinja2_templates_compiled')
